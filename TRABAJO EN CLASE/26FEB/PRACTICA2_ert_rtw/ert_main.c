...
void rt_OneStep(void)
{
   ...
   */
  PRACTICA2_SetEventsForThisBaseStep(eventFlags);
  ...
  currentTime = (extmodeSimulationTime_T) ((PRACTICA2_M->Timing.clockTick0 * 1)
    + 0)
    ;
  PRACTICA2_step0();
  ...
  if (need2runFlags[2]) {
    ...
    {
     case 2 :
      currentTime = (extmodeSimulationTime_T) ((PRACTICA2_M->Timing.clockTick2 *
        10) + 0)
        ;
      PRACTICA2_step2();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(PRACTICA2_M, 0);
  ...
  PRACTICA2_initialize();
  cli();
  sei ();

  /* External Mode initialization */
  errorCode = extmodeInit(PRACTICA2_M->extModeInfo, (extmodeSimulationTime_T *)
    rteiGetPtrTFinalTicks(PRACTICA2_M->extModeInfo));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(PRACTICA2_M, true);
    }
  }
  ...
  runModel =
    ...
    !rtmGetStopRequested(PRACTICA2_M);
